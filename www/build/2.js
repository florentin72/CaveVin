...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ajout__ = __webpack_require__(293);
...
var AjoutPage = /** @class */ (function () {
    ...
    AjoutPage.prototype.writewine = function (userId, v) {
        console.log("le vin a ajouter" + v.nom);
        __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('users/' + userId + "/vin" + v.nom).set({
            domaine: v.domaine,
            type: v.type,
            quantite: v.quantite
        });
    ...
    AjoutPage.prototype.addBottle = function () {
        ...
        var vin = new Vin(this.nom, this.domaine, this.quantite, this.type);
        console.log("vin nom : " + vin.nom);
        this.writewine(this.user.uid, new Vin(this.nom, this.domaine, this.quantite, this.type));
    };
    AjoutPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]) === "function" && _a || Object, typeof (_b 