...
var AjoutPage = /** @class */ (function () {
    ...
    AjoutPage.prototype.addBottle = function () {
        ...
        var vin = new __WEBPACK_IMPORTED_MODULE_2__model_vin__["a" /* Vin */](this.nom, this.domaine, this.type, 0);
        console.log("vin nom : " + vin.nom);
        this.writewine(new __WEBPACK_IMPORTED_MODULE_2__model_vin__["a" /* Vin */](this.nom, this.domaine, this.type, 0));
    };
